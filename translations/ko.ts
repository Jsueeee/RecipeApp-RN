export default {
  ...
  profile: {
    title: "프로필 설정",
    email: "이메일 주소",
    login_provider: "로그인 정보",
    login_provider_kakao: "카카오로 로그인",
    login_provider_naver: "네이버로 로그인",
    login_provider_google: "구글로 로그인",
    login_provider_apple: "애플로 로그인",
    edit_profile_image: "프로필 이미지 수정",
    edit_profile_nickname: "닉네임 수정",
    edit_profile_nickname_hint: "닉네임을 입력하세요",
    edit_profile_image_hint: "프로필 이미지를 선택하세요",
    edit_profile_image_cta: "저장",
    edit_profile_nickname_cta: "저장",
  },
  fridge: {
    my_fridge: "나의 냉장고",
    product_name: "상품명",
  ...
  recipe_detail: {
    ...
    in_fridge: "있는 재료",
    not_in_fridge: "없는 재료",
    create_recipe_is_empty: "재료를 1개 이상 추가해 주세요",
  },
  edit_food: {
    title: "재료 수정",
    remove: "삭제",
  ...
  recipe_my_create: {
    ...
    ingredients_bottom_sheet_edit_title: "레시피 재료 수정",
    ingredients_bottom_sheet_cta: "완료",
    ingredients_bottom_sheet_edit_cta: "수정",
